...
export default function ResponsiveFooter() {
    ...
    return (
        <div className="main-footer p-4 bg-[#1435c3] text-white">
            <div className="container  grid grid-cols-4 gap-4  mx-auto max-w-[1300px] ">
                ...
                <div className="main-footer-payment-method">
                    <label>
                        Trụ sở chính
                    </label>
                    <div className="pt-2 text-[15px]">
                        <p>Địa chỉ : vinhome grandpark quận 9</p>
                        <p>Hotline : <a href="tel:093 09393 0933"> 093 09393 0933 </a></p>
                        <p>Khuyến nại :<a href="tel:0358  09393 0933"> 0358 09393 0933 </a></p>
                        <p>Email   : dochinhlatoi113@gmail.com</p>
                    </div>
                </div>
                <div className="main-footer-map">
                    <label>
                        Bản đồ
                    </label>
                    <div className="pt-2 text-[15px]">
