    ...
    return (
        <>
            <li className="flex items-center space-x-2 hover:text-gray-300 header-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#b3b3b3" className="w-5 h-5">
                ...
                <a className="title-header-item" href="#">Show Room</a>
            </li>
            <li className="flex items-center space-x-2 hover:text-gray-300 header-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#b3b3b3" className="w-5 h-5">
                    <path fillRule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clipRule="evenodd" />
                </svg>
                <a className="title-header-item" href="#">Hotline</a>
            </li>
            <li className="flex items-center space-x-2 hover:text-gray-300 header-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#b3b3b3" className="w-5 h-5">
                ...
                <a className="title-header-item" href="#">Discount</a>
            </li>
            <li className="flex items-center space-x-2 hover:text-gray-300 header-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#b3b3b3" className="size-6">
                    <path fillRule="evenodd" d="M2.25 5.25a3 3 0 0 1 3-3h13.5a3 3 0 0 1 3 3V15a3 3 0 0 1-3 3h-3v.257c0 .597.237 1.17.659 1.591l.621.622a.75.75 0 0 1-.53 1.28h-9a.75.75 0 0 1-.53-1.28l.621-.622a2.25 2.25 0 0 0 .659-1.59V18h-3a3 3 0 0 1-3-3V5.25Zm1.5 0v7.5a1.5 1.5 0 0 0 1.5 1.5h13.5a1.5 1.5 0 0 0 1.5-1.5v-7.5a1.5 1.5 0 0 0-1.5-1.5H5.25a1.5 1.5 0 0 0-1.5 1.5Z" clipRule="evenodd" />
                </svg>
                <a className="title-header-item" href="#">Build Computer</a>
            </li>
            <li className="flex items-center space-x-2 hover:text-gray-300 ">
                ...
                <a className="title-header-item" href="#">News</a>
            </li>
        </>
    );
}
