...
import CountdownTimerReponsive from "./countdown-hotdeal";

export default function HotDealReponsive() {
    ...
    return (
        <div>
            {/* Countdown Timer */}
            <div>
                <CountdownTimerReponsive targetDate="2025-03-24T23:59:59" />
            </div>

            {/* Tabs */}
            <TabReponsive data={["Laptop", "PC", "Mouse","Beauty", "Monitor"]} />

            {/* Product Slider */}
            <div className="carousel w-full main-hot-deal ">
                <div className="carousel-item relative w-full overflow-hidden">
                    <div className="text-white grid grid-cols-2 gap-2 p-3">
